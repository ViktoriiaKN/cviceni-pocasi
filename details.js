...
predpoved.forEach((pocasiDetails) => {
  mainElem.innerHTML += `
  <div class="po-pa" ><h2>${pocasiDetails.den}</h2>
  <p>${pocasiDetails.denni_teplota, ranni_teplota, odpoledni_teplota, vecerni_teplota, stav_pocasi, tlak, rychlost_vetru, popis_pocasi}`
})
