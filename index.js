...
predpoved.forEach((pocasi) => {
  mainElement.innerHTML += `
  <div class="po-pa" ><h2>${pocasi.den}</h2>
  <p>${pocasi.datum}
  <a href='detail.html#&{pocasi.id}'>${pocasi.den}</a>`
})

// УВАГА!!! Я вказала pocasi як параметр форичу і потім маю усюди вживати його, а не predpoved 
